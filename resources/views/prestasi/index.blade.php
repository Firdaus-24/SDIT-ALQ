...
@section('container')
    ...
    <div class="container p-4 mx-auto mt-1">
        <h1 class="text-2xl lg:text-4xl text-bold mb-3">MASTER PRESTASI</h1>
        @if (session('msg'))
        ...
        <div class="w-full bg-white p-4 shadow-md rounded-lg mb-3">
            <h2 class="text-sm lg:text-lg font-bold mb-2">Form Master Prestasi</h2>
        ...
        <div class="w-full bg-white p-4 shadow-md rounded-lg overflow-x-auto">
            <table class="display text-xs lg:text-base" style="width:100%" id="tablePrestasi">
                <thead>
                    <tr>
    ...
    <div id="myModal" class="fixed top-0 left-0 w-full h-full flex items-center justify-center hidden">
        ...
        <div class="bg-white w-2/3 lg:w-1/3 p-6 rounded-lg z-50">
            ...
            <!-- Form -->
            <h5 class="uppercase font-bold mb-3 text-center">Update Master Prestasi</h5>
