...
@section('container')
    <div class="container p-4 mx-auto mt-1">
        ...
        @endif
        <form action="{{ route('jabatanImportProses') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="flex flex-col mt-3 text-center rounded-lg shadow-md bg-slate-800 dark:bg-white w-96">
                <h3 class="p-2 m-2 text-base font-semibold bg-[#948979] rounded-t-lg text-slate-300 lg:text-xl">Import file
                    jabatan</h3>
                <input type="file" name="file" id="file"
                    accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel"
                    class="p-1 m-2 text-sm lg:text-base">
                <button type="submit"
