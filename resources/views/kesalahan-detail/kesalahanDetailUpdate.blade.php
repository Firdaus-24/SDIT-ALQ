            ...
            <form action="{{ route('kesalahanDetailUpdate', ['id' => $data->id]) }}" method="post"
                ...
                <div class="flex flex-col lg:grid grid-cols-3 gap-4 mb-3">
                    ...
                    <div class="flex flex-col lg:col-span-2">
                        <input type="text" value="{{ $data->student->name }}" name="txtname" id="txtname"
                            autocomplete="off" autofocus class="rounded text-xs lg:text-sm w-full" maxlength="255"
                ...
                <div class="flex flex-col lg:grid grid-cols-3 gap-4 mb-3">
                    ...
                    <input type="text" value="{{ $data->student->kelas }}" name="txtkelas" id="txtkelas"
                        autocomplete="off" autofocus class="rounded text-xs lg:text-sm lg:col-span-2" readonly>
                </div>
                <div class="flex flex-col lg:grid grid-cols-3 gap-4 mb-3">
                    <label for="txtkesalahanId" class="text-xs lg:text-sm">Jenis Kesalahan</label>
                    <div class="flex flex-col lg:col-span-2">
                        <select name="txtkesalahanId" id="txtkesalahanId" class="rounded text-xs lg:text-sm lg:col-span-2"
                            required>
