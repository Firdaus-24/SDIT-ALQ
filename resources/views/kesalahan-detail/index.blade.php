...
@section('container')
    <div class="container p-4 mx-auto mt-1">
        <h1 class="mb-3 text-2xl lg:text-4xl text-bold dark:text-white">DETAIL KESALAHAN SISWA</h1>
            ...
            <table class="text-xs display lg:text-base" style="width:100%" id="tableDetailKesalahan">
                <thead>
                    <tr>
                        ...
                        <th class="px-6 py-2 text-xs text-gray-500 lg:text-sm">Kesalahan</th>
