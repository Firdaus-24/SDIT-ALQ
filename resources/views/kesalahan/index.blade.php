...
@section('container')
            ...
            <div class="min-w-full card card-grid">
                <div class="flex-wrap py-5 card-header">
                    ...
                    <div class="flex justify-end">
                        @if (auth()->user()->hasPermissionTo('kesalahan-siswa.create'))
                            <x-primary-button type="button" id="btn-add" data-modal-toggle="#modalKesalahan">
                ...
                <div class="card-body">
                    <div class="p-4 scrollable-x-auto">
                        <table class="table table-auto table-border" data-datatable-table="true" id="tableKesalahan">
                            <thead>
                                <tr>
                                    <th class="w-[30px]">
                                        <span class="sort">
    ...
    <!-- Modal -->
    <x-modal id="modalKesalahan" modalTitle="Form Master Kesalahan Siswa" modalSize="medium">
        <form action="" id="kesalahan-form">
    ...
    @push('js')
        <script>
            let modal = 'modalKesalahan';
            let formMain = 'kesalahan-form';
            let dataTableList;
            let options = {
                url: null,
                form: null,
                id: null,
                datatable: null,
                dataTitle: "kesalahan siswa",
            }

            $(function() {
                dataTableList = $('#tableKesalahan').DataTable({
                ...
                $(document).on('click', '#btn-delete', function() {
                    ...
                    options.url = `/kesalahan-siswa/${rowData.id}`;
