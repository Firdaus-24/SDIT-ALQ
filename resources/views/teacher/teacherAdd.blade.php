...
@section('container')
    <div class="container p-4 mx-auto mt-1">
        <h1 class="text-2xl lg:text-4xl text-bold mb-3"><span class="text-gray-500 hover:text-gray-950"><a
                    href="{{ route('teachers') }}">TEACHERS</a></span>->Form Teachers</h1>
        @if (session('msg'))
        ...
        <div class="w-full bg-white p-4 shadow-md rounded-lg overflow-x-auto">
            <form action="{{ route('teachersStore') }}" method="post" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="date" name="txttglkeluar" id="txttglkeluar" autocomplete="off"
                            class="rounded text-xs lg:text-sm">
                    </div>
                    <div class="flex flex-col">
