...
@section('container')
    <div class="container p-4 mx-auto mt-1">
        <h1 class="text-2xl lg:text-4xl text-bold mb-3"><span class="text-gray-500 hover:text-gray-950"><a
                    href="{{ route('student') }}">STUDENT</a></span>->Update Student</h1>
        @if (session('msg'))
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="text" value="{{ $data->agama }}" name="txtagama" id="txtagama" autocomplete="off"
                            class="rounded text-xs lg:text-sm" maxlength="20" required>
                        @error('txtagama')
                            <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex flex-col justify-end float-end">
                        <button type="submit"
                            class="bg-blue-500 p-2 text-white text-xs lg:text-base lg:w-24 float-right rounded-md">Update</button>
                    </div>
                </div>
            </form>
        </div>
