            ...
            <form action="{{ route('keterlambatanStore') }}" method="post" enctype="multipart/form-data"
                ...
                <div class="flex flex-col lg:grid grid-cols-3 gap-4 mb-3">
                    ...
                    <input type="text" value="{{ old('txtname') }}" name="txtname" id="txtname" autocomplete="off"
                        autofocus class="rounded text-xs lg:text-sm lg:col-span-2" maxlength="255"
                        onkeyup="searchNameTachers(this.value)" required>
                </div>
                ...
                <div class="flex flex-col lg:grid grid-cols-3 gap-4 mb-3">
                    ...
                    <input type="hidden" value="{{ old('txtjabatan') }}" name="txtjabatan" id="txtjabatan"
                        autocomplete="off" class="rounded text-xs lg:text-sm lg:col-span-2" maxlength="10" required>
