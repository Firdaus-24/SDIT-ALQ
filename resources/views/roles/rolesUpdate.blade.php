    ...
    <div class="container p-4 mx-auto mt-1">
        <h1 class="mb-3 text-2xl lg:text-4xl text-bold dark:text-white"><span
                class="text-gray-500 hover:text-gray-950 dark:hover:text-white"><a
                    href="{{ route('roles.index') }}">ROLES</a></span>->Form update roles</h1>
            ...
            <form action="{{ route('roles.update', $role->id) }}" method="post" class="flex justify-center"
                ...
                <div class="flex flex-col justify-center mt-2 w-[30rem]">
                    ...
                    <div class="flex flex-col my-3">
                        ...
                        <input type="hidden" name="txtroles" id="txtroles" required autocomplete="off" autofocus
                            class="text-xs rounded lg:text-sm" maxlength="100" value="{{ $role->id }}">
                        <input type="text" name="txtroles" id="txtroles" required autocomplete="off" autofocus
                            class="text-xs rounded lg:text-sm" maxlength="100" value="{{ $role->name }}">
                    </div>
